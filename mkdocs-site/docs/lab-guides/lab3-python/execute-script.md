...
!!! note "Multiple Browser Tabs"
    Keep both APIC GUI tabs open. After running the Python commands, you can immediately see the configuration changes applied across both fabrics simultaneously.
