...
![Python](../../assets/images/image019.png)
...
![Pip](../../assets/images/image020.png)
...
- The Python Code can now be viewed including # comments describing the script. Please refer to [**Appendix B**](/ACI_RoCEv2/appendicies/#appendix-b-python-script-explaination) to review the Python Script at greater detail:
