...
- The Python Code can now be viewed including # comments describing the script. Please refer to [**Appendix B**](/ACI_RoCEv2/appendices/#appendix-b-python-script-explaination) to review the Python Script at greater detail:
